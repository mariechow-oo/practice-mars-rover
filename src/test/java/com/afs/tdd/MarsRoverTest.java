...
class MarsRoverTest {
    ...
    @Test
    void should_got_to_0_0_N_when_execute_command_given_0_0_E_and_L() {
        // given
        MarsRover marsRover = new MarsRover(0, 0, "E");
        // when
        marsRover.executeCommand("L");
    ...
    @Test
    void should_got_to_0_0_S_when_execute_command_given_0_0_W_and_L() {
        // given
        MarsRover marsRover = new MarsRover(0, 0, "W");
        // when
        marsRover.executeCommand("L");
    ...
    @Test
    void should_got_to_0_0_W_when_execute_command_given_0_0_S_and_R() {
        // given
        MarsRover marsRover = new MarsRover(0, 0, "S");
        // when
    ...
    @Test
    void should_got_to_0_0_E_when_execute_command_given_0_0_N_and_R() {
        // given
        MarsRover marsRover = new MarsRover(0, 0, "N");
        // when
        marsRover.executeCommand("E");
        // then
        assertEquals(0, marsRover.getLocationX());
        assertEquals(0, marsRover.getLocationY());
        assertEquals("N", marsRover.getDirectionString());
    ...
    @Test
    void should_got_to_0_0_S_when_execute_command_given_0_0_E_and_R() {
        // given
        MarsRover marsRover = new MarsRover(0, 0, "E");
        // when
        marsRover.executeCommand("R");
    ...
    @Test
    void should_got_to_0_0_N_when_execute_command_given_0_0_W_and_R() {
        // given
        MarsRover marsRover = new MarsRover(0, 0, "W");
        // when
        marsRover.executeCommand("R");
    ...
    @Test
    void should_got_to_negative_1_1_N_when_execute_batch_command_given_0_0_N_and_MLMR() {
        // given
        MarsRover marsRover = new MarsRover(0, 0, "N");
        // when
